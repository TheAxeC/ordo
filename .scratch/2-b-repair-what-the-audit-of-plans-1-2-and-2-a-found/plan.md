...
- 19 the closing: `/roadmap done 2.B` with the gate's output, the diff shown to the user, this folder moved to `.scratch/archive/` (orchestrator, no agent)
